...
export const MOCK_SIGNALS: Signal[] = [
  {
    ...
    confidence: 0.87, repeat_count: 3, is_sent_telegram: true, trend_reversal: true, created_at: ago(3),
  },
  {
    ...
    confidence: 0.79, repeat_count: 1, is_sent_telegram: false, trend_reversal: false, created_at: ago(7),
  },
  {
    ...
    confidence: 0.93, repeat_count: 2, is_sent_telegram: false, trend_reversal: null, created_at: ago(11),
  },
  {
    ...
    confidence: 0.64, repeat_count: 1, is_sent_telegram: true, trend_reversal: true, created_at: ago(18),
  },
  {
    ...
    confidence: 0.71, repeat_count: 1, is_sent_telegram: false, trend_reversal: null, created_at: ago(24),
  },
  {
    ...
    confidence: 0.75, repeat_count: 4, is_sent_telegram: false, trend_reversal: false, created_at: ago(31),
  },
  {
    ...
    confidence: 0.96, repeat_count: 1, is_sent_telegram: true, trend_reversal: null, created_at: ago(45),
  },
  {
    ...
    confidence: 0.81, repeat_count: 2, is_sent_telegram: false, trend_reversal: null, created_at: ago(58),
  },
  {
    ...
    confidence: 0.52, repeat_count: 1, is_sent_telegram: false, trend_reversal: false, created_at: ago(72),
  },
  {
